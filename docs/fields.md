...
> ⚠️ Not all fields from the official content pack are currently implemented. The tables below reflect only the fields that have been successfully reproduced in this free version.
